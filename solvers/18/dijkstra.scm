(define-module (dijkstra)
               #:export (dijkstra-find-best-paths dijkstra-find-length-of-best-paths)
...
(define (dijkstra-find-length-of-best-paths start-node end-node discover-edges)
  (receive (previous distances)
           (dijkstra start-node discover-edges)
           (hash-ref distances end-node)))
